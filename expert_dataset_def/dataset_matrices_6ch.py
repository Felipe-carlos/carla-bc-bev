...
def get_camera_masks(
    ...
    """Gera as máscaras de atenção para as câmeras, com base no FOV.

    Args:
        H_bev (int, optional): _description_. Defaults to 32.
        W_bev (int, optional): _description_. Defaults to 32.
        H_img (int, optional): _description_. Defaults to 14.
        W_img (int, optional): _description_. Defaults to 30.
        n_cameras (_type_, optional): _description_. Defaults to None.
        batch (int, optional): _description_. Defaults to 4.
        n_heads (int, optional): _description_. Defaults to 4.
